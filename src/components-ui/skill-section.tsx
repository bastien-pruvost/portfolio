...
export const SkillSection = ({ skill }: SkillSectionProps) => {
  return (
    <div
      className={cn(
        'border-b border-grey-100 dark:border-grey-700 sm:odd:border-r lg:odd:border-r-0 xl:odd:border-r',
      )}
    >
      <Wrapper>
        ...
        <div
          className={cn(
            ...
            'min-[768px]:grid-cols-3 min-[1005px]:grid-cols-4 min-[1024px]:grid-cols-2 min-[1300px]:grid-cols-3',
            '',
          )}
        >
          {skill.technos &&
